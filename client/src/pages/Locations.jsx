...
const venueRoutes = ['/echolounge', '/houseofblues', '/pavilion', '/americanairlines']
    ...
    return (
        <div className='available-locations'>
            ...
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000.32 500" xmlSpace="preserve">
                ...
                <polygon id="venue1" onClick={() => navigate('/echolounge')} points="2.97,234.52 17.94,198.9 34.45,188.58 52.52,191.68 56.65,196.32 69.03,162.26 84,137.48
                ...
                <polygon id="venue2" onClick={() => navigate('/houseofblues')} points="358.58,353.74 376.65,322.77 389.55,314.52 384.39,280.45 407.61,272.19 422.06,220.58
                ...
                <polygon id="venue3" onClick={() => navigate('/pavilion')} points="998.06,83.81 952.65,31.16 914.45,16.71 877.29,43.55 833.94,102.39 811.74,161.23
                796.77,241.23 802.97,303.16 833.94,353.23 871.61,385.23 954.71,385.23 1000.32,387.81 " />

                <polygon id="venue4" onClick={() => navigate('/americanairlines')} points="625,291 615,305 608,318 625,338 637,354 622.5,358 673,363.5 751,363.5 793,363.5
                769,352 772,347 793,340 806,321 796.8,291 784,269 757,261 730,272 707,281 672,283 " />
            </svg>

            <div className='venue-labels'>
                {locations.map((loc, i) => (
                    <div key={loc.id} className={`venue${i + 1}-button-overlay`}>
                        <button onClick={() => navigate(venueRoutes[i])}>{loc.name}</button>
                    </div>
                ))}
            </div>
        </div>
